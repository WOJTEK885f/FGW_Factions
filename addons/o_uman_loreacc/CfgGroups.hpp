        ...
        class GVAR(Uman) {
            ...
            class Infantry_CompanionLed {
                ...
                class GVAR(Group_TerroristGroup) {
                    ...
                    class Unit0 { side = 0; vehicle = "FGW_O_Uman_Companion_Finn";   rank = "LIEUTENANT"; position[] = {0,0,0}; };
                    class Unit1 { side = 0; vehicle = "FGW_O_Uman_Terrorist_AK74M";  rank = "SERGEANT";   position[] = {5,-5,0}; };
                    class Unit2 { side = 0; vehicle = "FGW_O_Uman_Terrorist_AKS74U"; rank = "CORPORAL";   position[] = {-5,-5,0}; };
                    class Unit3 { side = 0; vehicle = "FGW_O_Uman_Terrorist_AK74M";  rank = "PRIVATE";    position[] = {10,-10,0}; };
                    class Unit4 { side = 0; vehicle = "FGW_O_Uman_Terrorist_AKS74U"; rank = "PRIVATE";    position[] = {-10,-10,0}; };
                };
                ...
                class GVAR(Group_ArmedForcesGroup) {
                    ...
                    class Unit0 { side = 0; vehicle = "FGW_O_Uman_Companion_Haaken"; rank = "LIEUTENANT"; position[] = {0,0,0}; };
                    class Unit1 { side = 0; vehicle = "FGW_O_Uman_Militant_AK12";    rank = "SERGEANT";   position[] = {5,-5,0}; };
                    class Unit2 { side = 0; vehicle = "FGW_O_Uman_Militant_AK74M";   rank = "CORPORAL";   position[] = {-5,-5,0}; };
                    class Unit3 { side = 0; vehicle = "FGW_O_Uman_Militant_AK12";    rank = "PRIVATE";    position[] = {10,-10,0}; };
                    class Unit4 { side = 0; vehicle = "FGW_O_Uman_Terrorist_AK74M";  rank = "PRIVATE";    position[] = {-10,-10,0}; };
                };
            };
        };
    };
