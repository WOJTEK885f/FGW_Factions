        ...
        class GVAR(CFR) {
            ...
            class Infantry {
                ...
                class GVAR(Group_ChernivkanMilitiaPatrol) {
                    ...
                    class Unit3 { side = 2; vehicle = "FGWF_I_CFR_Fighter";   rank = "PRIVATE";    position[] = {10,-10,0}; };
                    class Unit4 { side = 2; vehicle = "FGWF_I_CFR_Fighter";   rank = "PRIVATE";    position[] = {-10,-10,0}; };
                    class Unit5 { side = 2; vehicle = "FGWF_I_CFR_DM";        rank = "PRIVATE";    position[] = {15,-15,0}; };
                    class Unit6 { side = 2; vehicle = "FGWF_I_CFR_Fighter";   rank = "PRIVATE";    position[] = {-15,-15,0}; };
                };
