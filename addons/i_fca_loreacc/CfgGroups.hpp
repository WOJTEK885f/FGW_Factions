    ...
    class Indep {
        class GVAR(FCA) {
            ...
            class Infantry_CompanionLed {
                ...
                class GVAR(Group_MilitiaSquad_Bohdan) {
                    name = CSTRING(Group_MilitiaSquad_Bohdan);
                    side = 2;
                    faction = QGVAR(FCA);
                    icon = "\A3\ui_f\data\map\markers\nato\n_inf.paa";
                ...
                class GVAR(Group_InfantrySquad_Ostap) {
                    name = CSTRING(Group_InfantrySquad_Ostap);
                    side = 2;
                    faction = QGVAR(FCA);
                    icon = "\A3\ui_f\data\map\markers\nato\n_inf.paa";
                ...
                class GVAR(Group_Army_FieldPatrol_Stepan) {
                    name = CSTRING(Group_Army_FieldPatrol_Stepan);
                    side = 2;
                    faction = QGVAR(FCA);
                    icon = "\A3\ui_f\data\map\markers\nato\n_inf.paa";

                    class Unit0 { side = 2; vehicle = "FGWF_I_FCA_Companion_Stepan"; rank = "LIEUTENANT"; position[] = {0,0,0}; };
                    class Unit1 { side = 2; vehicle = "FGWF_I_FCA_Rifleman";         rank = "SERGEANT";   position[] = {5,-5,0}; };
                    class Unit2 { side = 2; vehicle = "FGWF_I_FCA_Militia";          rank = "CORPORAL";   position[] = {-5,-5,0}; };
                    class Unit3 { side = 2; vehicle = "FGWF_I_FCA_Militia";          rank = "PRIVATE";    position[] = {10,-10,0}; };
                    class Unit4 { side = 2; vehicle = "FGWF_I_FCA_Militia";          rank = "PRIVATE";    position[] = {-10,-10,0}; };
                };
